<?php
/**
Plugin Name: Trek Techno Babble
Plugin URI: https://github.com/dartiss/trek-techno-babble
Description: Display some "techno babble" at the top of your administration screen.
Version: 1.0
Author: David Artiss
Author URI: https://artiss.blog

@package trek-techno-babble
 */
 ...
 */
function ttb_create_babble( $text ) {
	$number      = wp_rand( 0, count( $text ) - 1 );
...
function ttb_show_in_admin() {
	...
	if ( substr( $second_word, 0, strlen( $first_word ) ) === $first_word ) {
		$babble = $second_word;
	} else {
		$babble .= $second_word;
	}
...
add_action( 'admin_head', 'ttb_add_css' );
